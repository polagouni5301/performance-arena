...
import AgentSidebar from "../components/navigation/AgentSidebar";
import AgentHeader from "../components/navigation/AgentHeader";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <CyberParticles count={30} color="purple" speed={0.2} connectDistance={50} showConnections={false} />
